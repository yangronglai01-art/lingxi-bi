...
| 表 | 说明 | 关键字段 |
| --- | --- | --- |
| `dim_product` | 产品维 | product_id, product_name, category(制动/传动/密封/电子件), unit_price |
...
- 区域差异：华东 > 华南 > 华北 > 西南
- 整体销售逐月增长 + 季节性波动
- 良率异常：轮速传感器(P006)/产线3 在 2026-03~05 缺陷率异常偏高（约 11%，正常约 2.5%），
  适合演示 AI 洞察「发现异常点」
