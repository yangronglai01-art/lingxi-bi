...
PRODUCTS: List[Product] = [
    Product("P001", "螺杆式空气压缩机", "压缩机",   68000.00, "产线1",   6, 0.30),
    Product("P002", "无油涡旋压缩机",   "压缩机",   42000.00, "产线1",   8, 0.33),
    Product("P003", "旋片式真空泵",     "真空设备",  6800.00, "产线2",  20, 0.35),
    Product("P004", "罗茨真空泵机组",   "真空设备", 28500.00, "产线2",  10, 0.32),
    Product("P005", "液压齿轮泵",       "液压件",   2200.00, "产线3",  55, 0.38),
    Product("P006", "精密齿轮轴",       "精密件",    280.00, "产线3", 260, 0.42),
]
