...
生成「恒岳汽车零部件」经营分析所需的 6 张表数据（3 维度 + 3 事实）。
...
3. **良率波动**：轮速传感器(P006) 在产线3 于 2026-03 ~ 2026-05 缺陷率阶段性
...
PRODUCTS: List[Product] = [
    Product("P001", "盘式制动器总成",   "制动",   380.00, "产线1", 120, 0.32),
    Product("P002", "陶瓷刹车片",       "制动",    85.00, "产线1", 800, 0.38),
    Product("P003", "变速箱同步器总成", "传动",   620.00, "产线2",  60, 0.30),
    Product("P004", "传动轴万向节",     "传动",   240.00, "产线2", 180, 0.35),
    Product("P005", "发动机密封垫片",   "密封",    45.00, "产线3", 500, 0.42),
    Product("P006", "轮速传感器",       "电子件", 120.00, "产线3", 300, 0.36),
]
...
CUSTOMERS: List[Customer] = [
    Customer("C001", "华东汽车集团",   "大客户",   "整车厂",   "R001", 0.35),
    Customer("C002", "南方客车制造",   "大客户",   "整车厂",   "R002", 0.35),
    Customer("C003", "华北重卡股份",   "大客户",   "整车厂",   "R003", 0.40),
    Customer("C004", "西部汽车工业",   "大客户",   "整车厂",   "R004", 0.55),
    Customer("C005", "华东快修连锁A",  "中小客户", "售后维修", "R001", 0.12),
    Customer("C006", "华南快修连锁B",  "中小客户", "售后维修", "R002", 0.12),
    Customer("C007", "华东零部件贸易", "中小客户", "售后市场", "R001", 0.18),
    Customer("C008", "华南汽配城",     "中小客户", "售后市场", "R002", 0.18),
    Customer("C009", "华北配件经销",   "中小客户", "售后市场", "R003", 0.60),
    Customer("C010", "西南汽配商贸",   "中小客户", "售后市场", "R004", 0.45),
    Customer("C011", "恒跃出口贸易",   "大客户",   "出口贸易", "R001", 0.35),
    Customer("C012", "南方出口贸易",   "大客户",   "出口贸易", "R002", 0.35),
]

# 良率异常窗口：轮速传感器(P006) 在产线3 缺陷率阶段性偏高的时间段
